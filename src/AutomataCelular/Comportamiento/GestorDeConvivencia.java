...
en una celda, llama al método 'convivirConSeresVivos' para gestionar las interacciones entre ellos.
Este último método hace una verificación en cada combinación de seres vivos que estpan en la celda y, si uno
de ellos es un animal, llama al método 'encuentro' de 'ConvivenciaAnimal' para determinar y ejecutar
la interacción apropiada a las reglas establecidas en los Patrones de Comportamiento, ya sea reproducción,
alimentación o comunicación, segun el tipo de seres vivos involucrados y el número total de seres vivos en la celda.
 */
...
public class GestorDeConvivencia {
    ...
    public GestorDeConvivencia(Tablero tablero) {
